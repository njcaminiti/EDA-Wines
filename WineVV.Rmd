...
Now, we've exposed two discrete sets of IQRs, the high ones for the semi-dry wines and the low ones for the dry wines. Unfortunately though, this has not provided any interesting insights. 
...
### One
```{r alcohol in white wines by sweetness}
ggplot(subset(all, color == "White")) + geom_point(aes(x=residual.sugar, y=alcohol, color=quality)) + geom_smooth(aes(x=residual.sugar, y=alcohol), method=lm) 
```
